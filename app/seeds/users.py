...
def seed_users():
    demo = User(username='demo', firstName='Demo', lastName='User', email='demo@nonogram.com', password='password', bio='Thank you for trying out Nonogram! 🐶', profilePictureUrl='https://res.cloudinary.com/jameschenn/image/upload/v1652254531/Nonogram/nono1_ptga38.png', privateStatus=False)
