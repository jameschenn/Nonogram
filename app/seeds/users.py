...
def seed_users():
    demo = User(username='demo', firstName='Demo', lastName='User', email='demo@aa.io', password='password', bio='Thank you for trying out Nonogram! 🐶', profilePictureUrl='', privateStatus='False')
